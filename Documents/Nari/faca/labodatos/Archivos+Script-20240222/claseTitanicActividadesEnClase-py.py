...
def clasificador_naive_instance(x):
    ...
    if (x.Pclass == 3) and (x.Fare > 11):
            return True
    elif x.Pclass == 1 and x.Age > 45 and x.Sex == 'female':
            return True
    elif x.Pclass == 2 and x.Age < 40:
            return True
    elif x.Pclass == 2 and x.Age > 35 and x.Sex == 'male':
            return True
    elif x.Age < 30:
            return True 
    elif x.Pclass == 1 and x.Age < 45:
        return True
    else:
        return False
