...
def main():
    ...
    carpeta = r"C:\Users\soler\Documents\Nari\faca\labodatos\Clases 06-08 - SQL - Archivos clase (template script + datos)-20240206\\"
    ...
    consultaSQL = """
                  SELECT instancia,
                         ...
                         COUNT(*) as cantidad
                  FROM examen
                  GROUP BY estado, instancia
                  ORDER BY estado, instancia
                  """
   ...
   # -----------
    ...
    consultaSQL = """
                  ...
                  WHERE NOT EXISTS(
                      SELECT *
                      FROM examen AS e2
                      WHERE e2.Instancia LIKE 'Recu%' AND e2.Nombre = e1.Nombre 
                      )
...
`
    ...
    consultaSQL = """
                  ...
                  LEFT OUTER JOIN examen AS e
                  ON de.nombre = e.nombre AND e.instancia = 'Parcial-02'   
                  """
    ...
    consultaSQL = """
                  ...
                  LEFT OUTER JOIN examen AS e
                  ON de.nombre = e.nombre AND e.instancia = 'Recuperatorio-01'      
                  """
    ...
    consultaSQL = """
                  ...
                  LEFT OUTER JOIN examen AS e
                  ON de.nombre = e.nombre AND e.instancia = 'Recuperatorio-02'    
                  """
    ...
    consultaSQL = """
                  SELECT d1.*,
                    CASE WHEN (d1.Recuperatorio_02 > 4 OR d1.Parcial_02 > 4) 
                                AND (d1.Recuperatorio_01 > 4 OR d1.Parcial_01 > 4)
                    THEN 'APROBO'
                    ELSE 'DESAPROBO'
                    END AS 'ESTADO'
